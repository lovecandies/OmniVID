...
| [功能实现地图](feature-implementation-map.md) | 按用户视角、后端落点、数据落点、验收方式和面试钩子拆解 1.0 全功能 |
| [面试包](interview-pack.md) | 简历钩子、面试总叙事和高频追问回答 |
| [完整面试题库](full-interview-question-bank.md) | 覆盖 MySQL、Redis、并发/JVM、Spring、MQ、网络/OS、RAG、ASR、URL 导入等追问题 |
| [2.0 路线](roadmap-2.0.md) | 1.0 之后再做的功能和技术升级 |
| [会话备份](session-backup-2026-06-10.md) | 当前可见会话脉络、关键决策和成果备份 |
| [完整对话与工作备份](conversation-and-work-backup.md) | 按时间线备份本项目所有关键需求、决策、实现、问题修正和 1.0/2.0 边界 |
| [代码文件职责地图](code-file-responsibility-map.md) | 逐个说明后端、前端、脚本、配置和文档文件职责，便于聊天记录丢失后继续开发 |
